 ...
 * 画像を反転させる
 */
JNIEXPORT void JNICALL Java_com_vsn_edit_cv_FlipImage_flipImg(
	JNIEnv			*env,
	jobject			thiz,
	jint			p_flipMode)			// 反転モード
{
	// NULLチェック
	if ( pImage != NULL )
	{
 ...
 * jint height : 高さ
 */
JNIEXPORT void JNICALL Java_com_vsn_edit_cv_FlipImage_setSourceImage(
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_vsn_edit_cv_FlipImage_getSourceImage(
